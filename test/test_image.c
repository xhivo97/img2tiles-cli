...
void test_check_extension()
{
	...
	assert(check_extension(STRING("/this/is/a/valid/image.png")) ==
		IMAGE_PNG);
	assert(check_extension(STRING("/this/is/a/valid/image.PNG")) ==
		IMAGE_PNG);
	...
	assert(check_extension(STRING("/this/is/a/valid/image.jpg")) ==
		IMAGE_JPEG);
	assert(check_extension(STRING("/this/is/a/valid/image.jpeg")) ==
		IMAGE_JPEG);
	assert(check_extension(STRING("/this/is/a/valid/image.JPG")) ==
		IMAGE_JPEG);
	assert(check_extension(STRING("/this/is/a/valid/image.JPEG")) ==
	...
	// Invalid extensions
	assert(check_extension(STRING("/not/valid.inv")) ==
		IMAGE_NOT_SUPPORTED);
